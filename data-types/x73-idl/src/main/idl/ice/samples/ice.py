...
@idl.struct(
    type_annotations = [idl.type_name("ice::TrialMarker")],
    member_annotations = {
        'runId': [idl.key, ],
        'trialNum': [idl.key, ],
        'eventType': [idl.bound(128)],
        'cmdType': [idl.bound(128)],
        'params': [idl.bound(128), idl.utf16],
    }
)
class ice_TrialMarker:
    runId: int = 0
    trialNum: idl.int32 = 0
    eventType: str = ""
    cmdType: str = ""
    value: idl.float32 = 0.0
    params: str = ""
...
ice.TrialMarker = ice_TrialMarker

ice_TrialMarkerTopic = "MDDTTrialMarker"

ice.TrialMarkerTopic = ice_TrialMarkerTopic
