...
public class AlarisMITM_backup extends AbstractSerialDevice {
	...
	private static final Logger log = LoggerFactory.getLogger(AlarisMITM_backup.class);
	...
	public AlarisMITM_backup(Subscriber subscriber, Publisher publisher, EventLoop eventLoop) {
		this(subscriber, publisher, eventLoop,2);
	}
	
	public AlarisMITM_backup(Subscriber subscriber, Publisher publisher, EventLoop eventLoop, int countSerialPorts) {
