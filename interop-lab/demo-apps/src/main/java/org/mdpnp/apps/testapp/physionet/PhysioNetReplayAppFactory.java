...
public class PhysioNetReplayAppFactory implements IceApplicationProvider {
    ...
    public IceApp create(ApplicationContext parentContext) throws IOException {
        ...
        com.rti.dds.subscription.Subscriber subscriber = 
            (com.rti.dds.subscription.Subscriber) parentContext.getBean("subscriber");
        org.mdpnp.rtiapi.data.EventLoop eventLoop = 
            (org.mdpnp.rtiapi.data.EventLoop) parentContext.getBean("eventLoop");
        ...
        PhysioNetReplayDevice device =
            new PhysioNetReplayDevice(subscriber, publisher, eventLoop, saWriter, numWriter);
