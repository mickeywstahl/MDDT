...
public class GenericControlApplication {
	...
	public GenericControlApplication() {
...
//                System.err.println("assignedSubscriber is "+assignedSubscriber);
	...
	class SimulatedEasyTivaDevice extends AbstractSerialDevice {
		...
		public SerialProvider getSerialProvider(int idx) {
			...
			serialProvider.setDefaultSerialSettings(115200, DataBits.Eight, Parity.None, StopBits.One, FlowControl.None);
