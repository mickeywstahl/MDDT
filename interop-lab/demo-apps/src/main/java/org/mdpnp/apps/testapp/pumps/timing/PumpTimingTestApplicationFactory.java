...
public class PumpTimingTestApplicationFactory implements IceApplicationProvider {
	
	private IceApplicationProvider.AppType type=new IceApplicationProvider.AppType(
			"Pump Timing", "NoPump", (URL) PumpTimingTestApplicationFactory.class.getResource("infpump.png"), 0.75, false
		);
	...
	public IceApp create(ApplicationContext parentContext) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(PumpTimingTestApplication.class.getResource("PumpTimeTestApplication.fxml"));
